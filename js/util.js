...
function renderHeader(includeFooter = true){
  ...
  // Header, footer
  $("body").prepend("<div id='header'><span class='title'><a title='JellyRoll Online' style='text-decoration:none; color:black' href='/'><img src='/fig/logo.png' height='100%'/><a></span></div>")
  ...
  $("#class2Selector div").append(`<a href='/class2/phe4'>PheRS-A&beta;</a>`);
	...
	$("#class2Selector div").append(`<a href='/class2/pro3'>ProRS-M</a>`);
